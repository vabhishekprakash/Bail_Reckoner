...
## Diff against the pre-M0 project text (RULES.md §3 / brief §2.1, "cross-checked bare-act
...
4. **Third proviso — substance match.** Gazette adds "**during the period of investigation,
   ...
   cap (gate 0, D-034).
5. **⚠️ THE EXPLANATION — ABSENT from every pre-M0 project document** (RULES.md §3, brief §2.1,
