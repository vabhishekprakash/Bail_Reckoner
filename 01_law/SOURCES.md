...
and page (RULES.md §6: a row without provenance does not enter the database). **Nothing in this
...
- **DATE CORRECTION established by the primary:** the project's records said "Crl. A. No.
  4258/2024, 27 December 2024" (RULES.md §3, the register, OLQ-1) — a secondary-source
  ...
  Explanation precedent). RULES.md §3's line is flagged for Abhishek's edit.
