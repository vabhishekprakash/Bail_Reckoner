...
Purity contract (RULES.md section 6, D-050): no network, no model, no file or database I/O
...
Gate order is fixed (RULES.md section 3, as amended by D-033/D-034). Six gates:
